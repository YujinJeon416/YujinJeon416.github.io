...
## Todo List
- [x]  웹사이트 레퍼런스 찾기 | 2021.02.25(목)
- [x]  페이지별 내용/레이아웃 기획하기
    - [x]  메인페이지 2021.02.27 (토)
    - [x]  자기소개 2021.02.27 (토)
    - [x]  좋아하는 것 2021.02.27 (토)
    - [x]  개발자 로드맵 2021.02.27 (토)
    - [x]  회원가입
        - [x]  로그인 2021.03.12 (목)
        - [x]  회원가입 2021.03.12 (목)
        - [x]  회원정보 열람 2021.03.16(화)
- [x]  제작 (~21.03.18(목))
    - [x]  화면 만들기
        - [x]  전체 레이아웃 2021.03.07 (일)
        - [x]  메인페이지  2021.03.07 (일)
        - [x]  자기소개  2021.03.07 (일)
        - [x]  좋아하는 것  2021.03.07 (일)
        - [x]  개발자 로드맵  2021.03.07 (일)
        - [x]  회원가입
            - [x]  로그인 2021.03.13 (토)
            - [x]  회원가입 2021.03.13 (토)
            - [x]  회원정보 열람 (테이블) 2021.03.17(수)
    - [x]  기능 구현
        - [x]  버튼 누르면 스크롤  2021.03.10 (수)
        - [x]  스크롤 애니메이션  2021.03.10 (수)
        - [x]  바 애니메이션  2021.03.10 (수)
        - [x]  버튼 애니메이션  2021.03.10 (수)
        - [x]  회원정보 불러와서 리스트로 출력 2021.03.17(수)
